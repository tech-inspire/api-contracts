...
func (x *PostCreatedEvent) Reset() {
	*x = PostCreatedEvent{}
	mi := &file_posts_v1_posts_service_events_proto_msgTypes[0]
...
func (*PostCreatedEvent) Descriptor() ([]byte, []int) {
	return file_posts_v1_posts_service_events_proto_rawDescGZIP(), []int{0}
}
...
func (x *PostUpdatedEvent) Reset() {
	*x = PostUpdatedEvent{}
	mi := &file_posts_v1_posts_service_events_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PostUpdatedEvent) Descriptor() ([]byte, []int) {
	return file_posts_v1_posts_service_events_proto_rawDescGZIP(), []int{1}
}
...
func (x *PostDeletedEvent) Reset() {
	*x = PostDeletedEvent{}
	mi := &file_posts_v1_posts_service_events_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PostDeletedEvent) Descriptor() ([]byte, []int) {
	return file_posts_v1_posts_service_events_proto_rawDescGZIP(), []int{2}
}
...
func (x *PostImageVariantsGeneratedEvent) Reset() {
	*x = PostImageVariantsGeneratedEvent{}
	mi := &file_posts_v1_posts_service_events_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PostImageVariantsGeneratedEvent) Descriptor() ([]byte, []int) {
	return file_posts_v1_posts_service_events_proto_rawDescGZIP(), []int{3}
}
...
var File_posts_v1_posts_service_events_proto protoreflect.FileDescriptor

const file_posts_v1_posts_service_events_proto_rawDesc = "" +
	"\n" +
	"#posts/v1/posts_service_events.proto\x12\bposts.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x14posts/v1/posts.proto\"q\n" +
...
var (
	file_posts_v1_posts_service_events_proto_rawDescOnce sync.Once
	file_posts_v1_posts_service_events_proto_rawDescData []byte
)

func file_posts_v1_posts_service_events_proto_rawDescGZIP() []byte {
	file_posts_v1_posts_service_events_proto_rawDescOnce.Do(func() {
		file_posts_v1_posts_service_events_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_posts_v1_posts_service_events_proto_rawDesc), len(file_posts_v1_posts_service_events_proto_rawDesc)))
	})
	return file_posts_v1_posts_service_events_proto_rawDescData
}

var file_posts_v1_posts_service_events_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_posts_v1_posts_service_events_proto_goTypes = []any{
...
var file_posts_v1_posts_service_events_proto_depIdxs = []int32{
...
func init() { file_posts_v1_posts_service_events_proto_init() }
func file_posts_v1_posts_service_events_proto_init() {
	if File_posts_v1_posts_service_events_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_posts_v1_posts_service_events_proto_rawDesc), len(file_posts_v1_posts_service_events_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_posts_v1_posts_service_events_proto_goTypes,
		DependencyIndexes: file_posts_v1_posts_service_events_proto_depIdxs,
		MessageInfos:      file_posts_v1_posts_service_events_proto_msgTypes,
	}.Build()
	File_posts_v1_posts_service_events_proto = out.File
	file_posts_v1_posts_service_events_proto_goTypes = nil
	file_posts_v1_posts_service_events_proto_depIdxs = nil
}
